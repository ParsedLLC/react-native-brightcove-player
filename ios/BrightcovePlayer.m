...
- (id<BCOVPlaybackController>)createPlaybackController {
    BCOVFPSBrightcoveAuthProxy *proxy = [[BCOVFPSBrightcoveAuthProxy alloc] initWithPublisherId:nil applicationId:nil];
...
- (void)playbackController:(id<BCOVPlaybackController>)controller playbackSession:(id<BCOVPlaybackSession>)session didReceiveLifecycleEvent:(BCOVPlaybackSessionLifecycleEvent *)lifecycleEvent {
    if(
       ...
       lifecycleEvent.eventType == kBCOVFPSErrorDomain ||
       lifecycleEvent.eventType == kBCOVPlaybackSessionErrorCodeLoadFailed ||
       lifecycleEvent.eventType == kBCOVPlaybackSessionErrorCodeNoPlayableSource) {
        self.onError(lifecycleEvent.properties);
    }
